...
setTimeout(async () => {
  if (process.env.NODE_ENV === 'development') {
    ...
    // const response = await request.post('/validate').send({ recording, user_id: '101010', source: 'recording' }).set(headers);
    ...
    // const response = await request.get('/drops?offset=0&limit=10').send();
    // const response = await request.get('/user/BHOqOcVUaVVbfRGT5ru3lYyLJTJ3?offset=0&limit=10').send();
    // const response = await request.get('/drops/bc811b87-2677-41d5-800c-cce75e0e154b').send();
    // const response = await request.post('/filter/duet').send({ user_id: 'BHOqOcVUaVVbfRGT5ru3lYyLJTJ3', tags: ['4371e33d-a5b5-42d2-b195-631307b7a2ce', '00ba23bd-17e1-4001-aac0-87603c8ea18f'] });//0b73a901-f4d3-4476-a3ac-cb2d343c228d
